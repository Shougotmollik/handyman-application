...
class BookingStatusFilterBottomSheet extends StatefulWidget {
  ...
  const BookingStatusFilterBottomSheet({Key? key, required this.scrollController}) : super(key: key);
        ...
        child: Column(
          ...
          children: [
            Row(
              ...
              children: [
                Text(locale.filterBy, style: boldTextStyle()),
                IconButton(
            ...
            24.height,
            Text(locale.bookingStatus, style: primaryTextStyle()),
            24.height,
                ...
                AppButton(
                  ...
                  onTap: () {
                    ...
                    if (selectedCount >= 1) {
                      ...
                      toast(locale.filterAtLeastOneBookingStatusToast);
                    }
                  },
                ).expand(),
              ],
